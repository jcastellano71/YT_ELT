...
@pytest.fixture
def api_key():
    with mock.patch.dict("os.environ", AIRFLOW_VAR_API_KEY="MOCK_KEY1234"): #temporary update the environment dictionary with the key value
     yield Variable.get("API_KEY") # provide the value to the test that request this fixture. Fetches the value of any airflow variable
