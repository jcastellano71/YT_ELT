...
def test_youtube_api_response(airflow_variable):
    ...
    #url = f"https://youtube.googleapis.com/youtube/v3/channels?part=contentDetails&forHandle=MrBeast&key=AIzaSyD4ZP6t_L95XFh-R6zTWt0CJkyo68nVwYY"
...
def test_real_postgres_connection(real_postgres_connection):
    ...
    try:
        ...
        pytest.fail(f"Database quwey failed: {e}")
